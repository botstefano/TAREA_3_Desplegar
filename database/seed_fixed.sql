...
VALUES
  ...
  ('55555555-5555-4555-8555-555555555556', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa'),
  ...
  ('66666666-6666-4666-8666-666666666667', 'aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa')
...
ON CONFLICT (id) DO NOTHING;
'@;
Set-Content -Path .\database\seed.sql -Value $sql -Encoding utf8